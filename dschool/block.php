		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Block Listed Student</marquee></h2>
									<!-- tables -->
			
									
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Block Listed Student</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>ID</th>
...
//$sql = $DBcon->query("SELECT * FROM customer WHERE c_id = (SELECT MAX(c_id) FROM customer)");
	...
	$sql = $DBcon->query("SELECT * FROM student WHERE s_flag = '10' ");
											...
											<tbody>
											  <tr>
												...
												<?php } ?>
											<?php $qry = $DBcon->query("SELECT count(s_id) as count FROM student WHERE s_flag = '10'");
									$row = $qry->fetch_array();
									$count = $row['count'];
