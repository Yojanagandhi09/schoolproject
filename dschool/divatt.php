		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Search Todays Attendance</marquee></h2>

							<form method="post">
							
							<input type="search" name="searchname" class = "form-control" placeholder="Enter Standard-DIV-Roll Number" >
							...
							<!-- tables -->
									...
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Attendance</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>Student ID</th>
...
if (isset($_POST['search']))
{
	...
	$search3 = $_POST["searchdate"];

//$sql = $DBcon->query("SELECT * FROM marks WHERE m_id = (SELECT MAX(m_id) FROM customer)");
	$sql = $DBcon->query("SELECT * FROM attendance WHERE p_rollno LIKE '%$search1%' AND p_date = '$search3' ");
	//$sql = $DBcon->query("SELECT * FROM marks WHERE m_id = '$get'  ");
					...
					?>
										...
										<?php }
								$qry = $DBcon->query("SELECT count(p_id) as count FROM attendance WHERE p_rollno LIKE '%$search1%' AND p_date = '$search3' ");				
								$row = $qry->fetch_array();
										$count = $row['count'];
										echo ("This is the Todays Attendance : $count").	"</br>";
											?>
										<?php } ?>
												</table>
											  <!--<tr>
