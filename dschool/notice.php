...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								<li><a href="smain-page.php"> <i class="fa fa-tachometer"></i> Dashboard</a></li>
									<!--<li>
									...
									<li>
									<a href="notice.php"> <i class="fa fa-eye" aria-hidden="true"></i>View Notice </a> 
									<!--<ul class="gn-submenu">
								...
								<li>
									<a href="attendance.php"> <i class="fa fa-eye" aria-hidden="true"></i>View Attendance </a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="totalmark.php"> <i class="fa fa-eye" aria-hidden="true"></i>View Total Marks</a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo"><h1><a href="smain-page.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>School </a></h1></li>
				...
				<li class="second w3l_search">
						...
						<form method="post">
							<input type="search" name="searchname" placeholder="Search notice name here..." >
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<!-- breadcrumbs -->
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									<li><a href="smain-page.php">Home</a><span>«</span></li>
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">View Notice</marquee></h2>
									<!-- tables -->
			
									
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">View Notice</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>ID</th>
...
//$sql = $DBcon->query("SELECT * FROM customer WHERE c_id = (SELECT MAX(c_id) FROM customer)");
	$sql = $DBcon->query("SELECT * FROM notice WHERE n_name LIKE '%$search%' ORDER BY n_id DESC");
											...
											<?php $reimg = $row['n_pdf']; ?>
											  <tr>
												...
												<td><?php echo "<a target='_blank' href = '$path/$reimg'>View Notice</a>"?></td>
												</tr>
												<?php } ?>
												<?php } ?>
												</tbody>
