					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="addnotice.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Notice <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
								...
								<li>
									<a href="addtea.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add Teacher <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="stustatus.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>View Student Status <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="attstu.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>View Students Attendance <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="anotice.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>View Notice <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">View Students Marksheet</h2>
...
$sql = $DBcon->query("SELECT * FROM marks WHERE m_name LIKE '%$search1%' OR m_rollno LIKE '%$search2%'
