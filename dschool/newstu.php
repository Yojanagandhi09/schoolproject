		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Search New Admissions</marquee></h2>
					...
					<option name="year" value=""  selected>Select Academic year </option>
							...
							<input type="search" name="searchname" class ="form-control" placeholder="Standard to which admission" >
							<input type="search" name="searchlyp" class ="form-control" placeholder="From %" >
							<input type="search" name="searchlyp1" class ="form-control" placeholder="To %" >
					...
					<input type = "button" value = "Print This Page" onclick = "window/print()">
									...
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">View New Admissions</h3>
											...
											<thead>
											  <tr>
												...
												<th>Date of Birth</th>
												<th>Gender</th>
												<th>Class to which admission</th>
												<th>Last Year Percentage </th>
												<th>City</th>
												<th>Address</th>
												<th>PinCode</th>
												<th>Name of last School</th>
...
//$sql = $DBcon->query("SELECT * FROM enquiry WHERE  e_year LIKE '%$search1%' 
//OR e_dropdown LIKE '%$search2%' AND e_lyp between '$search3' and '$search4' ");

$sql = $DBcon->query("SELECT * FROM enquiry WHERE  e_year = '$search1' 
AND e_dropdown LIKE '%$search2%' AND e_lyp between '$search3' and '$search4' ");
										...
										while ($row = $sql->fetch_array())
										{
											...
											<tbody>
											  ...
											  <tr>
												...
												<td><a href="delete3.php?id=<?php echo  $row['0']; ?> ">Delete</a></td>
												</tr>
												</tbody>
										<?php }
			$qry = $DBcon->query("SELECT count(e_id) as count FROM enquiry WHERE e_year = '$search1' 
			AND e_dropdown LIKE '%$search2%' AND e_lyp between '$search3' and '$search4' ");
									$row = $qry->fetch_array();
									$count = $row['count'];
