...
$query=("INSERT INTO attendance (p_name , p_rollno ,p_attendance , p_date , p_teacher , p_year) 
VALUE( '$b', '$c' , '$d' ,'$e' , '$f', '$g' )");
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<!-- breadcrumbs -->
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									<li><a href="presentee.php">Student Attendance</a><span>«</span></li>
									<li>Add Student Attendance</li>
								</ul>
							</div>
						</div>
					<!-- //breadcrumbs -->
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Add Student Attendance</marquee></h2>
...
<b>Student ID</b> :
<input type="text" value="<?php echo $row['0'];?>"  name="p_id" readonly></br></br>
...
value="<?php echo $row['4'];?>" placeholder="Update Student Roll Number"> </br></br>

<b>Class Teacher</b> : 
<input type="text" name="teacher" id="teacher"
value="<?php echo $row['5'];?>" > </br></br>

<b>Academic Year</b> : 
<input type="text" name="year" id="year"
value="<?php echo $row['6'];?>" > </br></br>
