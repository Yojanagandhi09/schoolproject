		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Attendance</marquee></h2>
...
//	$sql = $DBcon->query("SELECT * FROM attendance WHERE p_name = '$pname'  ");
	$sql = $DBcon->query("SELECT * FROM attendance WHERE p_name = '$pname' AND p_year = '$search'  ");
									...
									while($row = $sql->fetch_array())
										...
										<?php } 
										$qry = $DBcon->query("SELECT count(p_id) as count FROM attendance WHERE p_name = '$pname'
										AND p_year = '$search'");				
								$row = $qry->fetch_array();
										$count = $row['count'];
										echo ("This is the Total Attendance : $count").	"</br>";
										?>
										<?php } ?>
												</table>
											  <!--<tr>
