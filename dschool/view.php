		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<li class="second w3l_search">
						...
						<form method="post">
							<input type="search" name="searchid" placeholder="Search here..." >
		...
		<!-- /inner_content-->
				<div class="inner_content">
						...
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									...
									<li><a href="stusta.php">Add & View Student Marksheet</a><span>«</span></li>
									
									<li>View & Update Student Marksheet </li>
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">View & Update Student Marksheet</marquee></h2>
									<!-- tables -->
			
									
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">View & Update Student Marksheet</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>Student ID</th>
...
//$sql = $DBcon->query("SELECT * FROM marks WHERE m_id = (SELECT MAX(m_id) FROM customer)");
	//$sql = $DBcon->query("SELECT * FROM marks WHERE m_id LIKE '%$search%' ORDER BY m_id DESC ");
	$sql = $DBcon->query("SELECT * FROM marks WHERE m_id = '$get'  ");
										...
										$row = $sql->fetch_array();
											...
											<?php $reimg = $row['m_marks']; ?>
											  ...
											  <tr>
												...
												<td><?php echo "<a target='_blank' href = '$path/$reimg'>View</a>"?></td>
