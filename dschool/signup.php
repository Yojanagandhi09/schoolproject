...
{
	$query = "INSERT INTO admin (a_name,a_cont,a_email,a_pass,a_flag)
VALUES ('$a_name','$a_cont','$a_email','$hashed_password','2')";	
...
<body>
 ...
 <input type="text" name="cont" placeholder=" Enter admin contact" required="">
...
<input type="password" name="pass" placeholder="Enter admin Password" required="">
		...
		<input type="submit" name = "submit" value="SIGN UP">
													...
													<h6><a href="editform.php">Update</a><h6>
