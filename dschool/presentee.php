		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Student Attendance</marquee></h2>
									<!-- tables -->
			
									
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Student Attendance</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>ID</th>
	...
	$sql = $DBcon->query("SELECT * FROM student WHERE s_teacher = '$tname' and s_flag = '4'");
											...
											<tbody>
											  <tr>
												...
												<td><a href="update2.php?id=<?php echo  $row['0']; ?> ">Present/Absent</a></td>
												<td><a href="hide3.php?id=<?php echo  $row['0']; ?> ">Delete</a></td>
												</tr>
												<?php } ?>
												</tbody>
												</table>
