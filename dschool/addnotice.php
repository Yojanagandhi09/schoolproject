...
if (isset ($_POST ['submit']))
{
	...
	$time = time();
	$actual_image_name = $_FILES['pdf']['name'];
	...
	$query = "INSERT INTO notice (n_name,n_date,n_pdf)
VALUES ('$n_name','$n_date','$reimg')";	
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction="right">Add Notice</marquee></h2>
...
<p><i>Enter Notice details below</i></p>
<hr>

 <input type="text" name="name" placeholder="Enter Notice name"  class="form-control" required=""></br>
 <input type="date" name="date" class="form-control" required=""></br>
<b>Upload Notice</b>:
<input type="file" name="pdf"  id = "pdf" value = ""  required="">
