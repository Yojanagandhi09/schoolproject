					   ...
					   <div class="agile_top_w3_grids">
					          <ul class="ca-menu">
										...
										<a href="addnotice.php">
										  <i class="fa fa-user" aria-hidden="true"></i>
											<div class="ca-content">
												...
												<h3 class="ca-sub one">Add Notice</h3>
											</div>
										</a>
									</li>
									...
									<li>
										<a href="addtea.php">
										  <i class="fa fa-user" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one"></h4>
												<h3 class="ca-sub one">Add Teacher</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="addstu.php">
										  <i class="fa fa-user" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one"></h4>
												<h3 class="ca-sub one">Add Student</h3>
											</div>
										</a>
									</li>
									...
									<li>
										...
										$qry = $DBcon->query("SELECT count(m_id) as count FROM marks ");
										$row = $qry->fetch_array();
										$count = $row['count'];
										echo ("Total Students : $count").	"</br>";
										?>	</h4>
												<h3 class="ca-sub one">View Students Marksheet</h3>
											</div>
										</a>
									</li>
										...
										<a href="attstu.php">
										  <i class="fa fa-eye" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one"></h4>
												<h3 class="ca-sub one">View Student Attendance </h3>
											</div>
										</a>
									</li>
									...
									<li>
										<a href="anotice.php">
										  <i class="fa fa-eye" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one"></h4>
												<h3 class="ca-sub one">View Notice </h3>
											</div>
										</a>
									</li>
									<li>
										<a href="todaysatt.php">
										  <i class="fa fa-eye" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one"></h4>
												<h3 class="ca-sub one">View Daily Attendance </h3>
											</div>
										</a>
									</li>
									<li>
										<a href="newstu.php">
										  <i class="fa fa-eye" aria-hidden="true"></i>
											<div class="ca-content">
												...
												<?php
													include('dbconnect.php');
										$qry = $DBcon->query("SELECT count(e_id) as count FROM enquiry ");
										$row = $qry->fetch_array();
										$count = $row['count'];
										echo ("Total New Students : $count").	"</br>";
										?>	
												</h4>
												<h3 class="ca-sub one">View New Admissions </h3>
											</div>
										</a>
									</li>
										...
										<a href="block.php">
										  <i class="fa fa-eye" aria-hidden="true"></i>
											<div class="ca-content">
												...
												<?php
													include('dbconnect.php');
										$qry = $DBcon->query("SELECT count(s_id) as count FROM student WHERE s_flag = '10' ");
										$row = $qry->fetch_array();
										$count = $row['count'];
										echo ("Total Block Listed Students : $count").	"</br>";
										?>	
												</h4>
												<h3 class="ca-sub one">Block Listed Students </h3>
											</div>
										</a>
									</li>
						...
						<div class="col-md-4 profile-main">
						    <div class="profile_bg_agile">
								...
								<div class="profile-ser">
										<div class="follow-grids-agileits-katareinfo">
