...
$query=$DBcon->query("SELECT * FROM student WHERE s_id='$get'");
...
$f=$_POST['year'];
	$time = time();
	$actual_image_name = $_FILES['marks']['name'];
	$reimg = $time.$actual_image_name; 
	$size = $_FILES['marks']['size'];
	$tmp = $_FILES['marks']['tmp_name'];
...
$query=("INSERT INTO marks (m_id ,m_name , m_rollno , m_lyp , m_date , m_year ,m_marks ) 
VALUE('$a' , '$b' , '$c' ,'$d' ,'$e' ,'$f' , '$reimg' )");
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="stusta.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Add & View Student Marksheet  <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="presentee.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>Student Attendance  <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="attview.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>View Attendance  <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="divatt.php"> <i class="fa fa-file-text-o" aria-hidden="true"></i>View Daily Attendance  <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<!-- breadcrumbs -->
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									<li><a href="stusta.php">Add Student status</a><span>«</span></li>
									<li>Add Marks & Attendance</li>
								</ul>
							</div>
						</div>
					<!-- //breadcrumbs -->
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Add Marks & Attendance</marquee></h2>
...
<b>Student Name</b> :
<input type="text" value="<?php echo $row['1']?>" name="s_name" id="s_name" readonly></br></br>

<b>Student Contact</b> :
<input type="text" value="<?php echo $row['2']?>" name="s_cont" id="s_cont" readonly></br></br>

<b>Student Email</b> :
<input type="text" value="<?php echo $row['3']?>" name="s_email" id="s_email" readonly></br></br>

<b>Student Roll Number</b> :
<input type="text" value="<?php echo $row['4']?>" name="s_rollno" id="s_rollno" readonly></br></br>
...
<p><i><span style ="color:red">Add Student marksheet below</span></i></p>
</br>
...
<input type="hidden" value="<?php echo $row['0'];?>"  name="m_id" >

<b>Student Name</b> : 
<input type="text" name="name" id="name"
value="<?php echo $row['1']?>" placeholder="Enter Student Name"> </br></br>

<b>Student Roll Number</b> : 
<input type="text" name="rollno" id="rollno"
value="<?php echo $row['4']?>" placeholder="Enter Student Roll Number"> </br></br>

<b>Last Year Percentage</b> : 
<input type="text" name="lyp" id="lyp"
value="" placeholder="Last Year Percentage"> </br></br>

<b>Marksheet Date</b> : 
<input type="date" name="date" id="date"
value="" placeholder="Marksheet date"> </br></br>

<b>Academic Year</b> : 
<input type="text" name="year" id="year"
value="<?php echo $row['6']?>" placeholder="Academic Year"> </br></br>
...
<hr/>
										...
										<p>
											...
											<a href ="stusta.php" class="btn btn-danger">Back</a>
