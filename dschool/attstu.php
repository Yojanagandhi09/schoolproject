		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Search Student Attendance</marquee></h2>
					...
					<option name="year" value=""  selected>Select Academic year </option>
							...
							<input type="search" name="searchname" class = "form-control" placeholder="Search Student Name or Roll number..." >
							<button class="btn btn-default" type="submit" name = "search" ><i class="fa fa-search" aria-hidden="true"></i></button></form>
