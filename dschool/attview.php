		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">View Attendance</marquee></h2>
					...
					<option name="year" value=""  selected>Select Academic year </option>
							...
							<input type="search" name="searchname" class ="form-control" placeholder="Search Student Name" >
					...
					<input type = "button" value = "Print This Page" onclick = "window/print()">
									...
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">View Attendance</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>Student ID</th>
...
//$sql = $DBcon->query("SELECT * FROM marks WHERE m_id = (SELECT MAX(m_id) FROM customer)");
	$sql = $DBcon->query("SELECT * FROM attendance WHERE p_year LIKE '%$search1%' AND p_name LIKE '%$search2%' ");
					...
					?>
											...
											<tbody>
											  ...
											  <tr>
												...
												<?php }
								$qry = $DBcon->query("SELECT count(p_id) as count FROM attendance WHERE p_year LIKE '%$search1%'
								AND p_name LIKE '%$search2%' ");				
								$row = $qry->fetch_array();
										$count = $row['count'];
										echo ("This is Studnent Total Attendance : $count").	"</br>";
											?>
										<?php } ?>
										</table>
											  <!--<tr>
