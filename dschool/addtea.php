...
$hashed_password = password_hash ($t_pass , PASSWORD_DEFAULT);

$check_name = $DBcon->query ("SELECT * FROM teacher WHERE t_name = '$t_name' ");
$check_email = $DBcon->query ("SELECT * FROM teacher WHERE t_email = '$t_email' ");
$count1 = $check_name->num_rows;
$count2 = $check_email->num_rows;

if ($count1 == 0 && $count2 == 0 )
{
	$query = "INSERT INTO teacher (t_name,t_cont,t_email,t_pass,t_flag)
VALUES ('$t_name','$t_cont','$t_email','$hashed_password','3')";	
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction="right">Add Teacher</marquee></h2>
...
<form  method="post">
<p><i>Enter Teacher details below</i></p>
<hr>

 <input type="text" name="name" placeholder="Enter Teacher name"  class="form-control" required=""></br>
 <input type="text" name="cont" placeholder=" Enter Teacher contact" class="form-control" required=""></br>
<input type="text" name="email" placeholder="Enter Teacher email" class="form-control" required=""></br>
<input type="password" name="pass" placeholder="Enter Teacher Password" class="form-control" required=""></br>
