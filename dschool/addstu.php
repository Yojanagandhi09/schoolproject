...
$check_name = $DBcon->query ("SELECT * FROM student WHERE s_name = '$s_name' ");
$check_email = $DBcon->query ("SELECT * FROM student WHERE s_email = '$s_email' ");
$count1 = $check_name->num_rows;
$count2 = $check_email->num_rows;

if ($count1 == 0 && $count2 == 0 )
{
	$query = "INSERT INTO student (s_name,s_cont,s_email,s_rollno,s_teacher,s_year,s_pass,s_flag)
VALUES ('$s_name','$s_cont','$s_email','$s_rollno','$s_teacher','$s_year','$hashed_password','4')";	
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Add Student</marquee></h2>
...
<form  method="post">
<p><i>Enter Student details below</i></p>
<hr>

 <input type="text" name="name" placeholder="Enter Student name"  class="form-control" required=""></br>
 <input type="text" name="cont" placeholder=" Enter Student contact" class="form-control" required=""></br>
<input type="text" name="email" placeholder="Enter Student email" class="form-control" required=""></br>
<input type="text" name="rollno" placeholder="Enter Student roll number" class="form-control" required=""></br>
<input type="text" name="teacher" placeholder="Enter Teacher name" class="form-control" required=""></br>
...
<input type="password" name="pass" placeholder="Enter Student Password" class="form-control" required=""></br>
			...
			<hr>
										<p>
											...
											<a href = "amain-page.php" class="btn btn-danger">Back</a>
											</p>
									</form>
								</div>
							</div>
