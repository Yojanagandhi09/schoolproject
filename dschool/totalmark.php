		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Total Marks</marquee></h2>
									<!-- tables -->
			
									
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Total Marks</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>Student ID</th>
...
include ("lock2.php");
	...
	$sql = $DBcon->query("SELECT * FROM marks WHERE m_name = '$sname'  ");
