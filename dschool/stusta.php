					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="tnotice.php"> <i class="fa fa-eye" aria-hidden="true"></i>View Notice </a> 
									<!--<ul class="gn-submenu">
								...
								<li>
									<a href="stusta.php"> <i class="fa fa-user" aria-hidden="true"></i>Add & View Student Marksheet  </a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="presentee.php"> <i class="fa fa-user" aria-hidden="true"></i>Student Attendance </a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="attview.php"> <i class="fa fa-eye" aria-hidden="true"></i>View Attendance  </a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
								...
								<li>
									<a href="divatt.php"> <i class="fa fa-eye" aria-hidden="true"></i>View Daily Attendance  </a> 
									<!--<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Inputs</a></li>
										<li class="mini_list_w3"><a href="validation.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Validation</a></li>
									</ul>-->
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<!-- breadcrumbs -->
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									<li><a href="tmain-page.php">Home</a><span>«</span></li>
									
									<li>Add & View Student Marksheet</li>
								</ul>
							</div>
						</div>
					<!-- //breadcrumbs -->
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Add & View Student Marksheet</marquee></h2>
									<!-- tables -->
			
									
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Add & View Student Marksheet</h3>
											<table id="table">
											<thead>
											  <tr>
												<th>ID</th>
												...
												<th>Class Teacher</th>
												<th>Academic Year</th>
												<th>Add Student Marksheet</th>
												<th>View Student Marksheet</th>
												<th>Action</th>
												</tr>
											</thead>
		<?php 
...
//$sql = $DBcon->query("SELECT * FROM customer WHERE c_id = (SELECT MAX(c_id) FROM customer)");
	//$sql = $DBcon->query("SELECT * FROM student WHERE s_name LIKE '%$search%' ");
	$sql = $DBcon->query("SELECT * FROM student WHERE s_teacher = '$tname' and s_flag = '4' ");
											...
											<tbody>
											  <tr>
												...
												<td><a href="addmarks.php?id=<?php echo  $row['0']; ?> ">Add Marksheet </a></td>
												<td><a href="view.php?id=<?php echo  $row['0']; ?>">View Marksheet </a></td>
												<td><a href="hide2.php?id=<?php echo  $row['0']; ?> ">Delete</a></td>
												</tr>
												<?php } ?>
												</tbody>
												</table>
