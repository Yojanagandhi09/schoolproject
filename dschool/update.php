...
$query=("UPDATE marks SET m_name='$b' , m_rollno='$c' ,m_lyp='$d' , m_date='$e' , m_marks='$reimg' WHERE m_id='$a' ");
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<!-- breadcrumbs -->
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									<li><a href="stusta.php">View Student Marksheet</a><span>«</span></li>
									<li>Update Student Marksheet </li>
								</ul>
							</div>
						</div>
					<!-- //breadcrumbs -->
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle"><marquee direction ="right">Update Student Marksheet</marquee></h2>
...
value="<?php echo $row['3'];?>" placeholder="Update Last Year Percentage"> </br></br>

<b>Marksheet Date</b> : 
<input type="date" name="date" id="date"
value="<?php echo $row['4'];?>" placeholder="Update Marksheet date"> </br></br>

<b>Update Student Marksheet</b> : 
<input type="file" name="marks" id="marks" value="<?php echo $row['4'];?>" > 
...
<div class="copyrights">
	 <p>© 2017 Esteem. All Rights Reserved | Design by  <a>Abhange</a> </p></div>	
